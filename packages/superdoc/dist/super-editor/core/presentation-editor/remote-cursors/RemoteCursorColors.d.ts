 ...
 * a valid index.
 */
export declare function getFallbackCursorColor(clientId: number, fallbackColors: readonly string[]): string;
/**
 ...
 */
export declare function validateCursorColor(color: string, clientId: number, fallbackColors: readonly string[]): string;
//# sourceMappingURL=RemoteCursorColors.d.ts.map