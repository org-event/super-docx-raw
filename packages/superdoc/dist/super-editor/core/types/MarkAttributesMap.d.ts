...
export type MarkName = {
    [K in keyof MarkAttributesMap]: K;
}[keyof MarkAttributesMap];
/**
 ...
 * ```
 */
export declare function isMarkType<M extends MarkName>(mark: {
    type: {
        name: string;
    };
    attrs: unknown;
}, name: M): mark is TypedMark<M>;
//# sourceMappingURL=MarkAttributesMap.d.ts.map