 ...
 */
export function preProcessIndexInstruction(nodesToCombine: import("../../v2/types/index.js").OpenXmlNode[], instrText: string, _docx?: import("../../v2/docxHelper").ParsedDocx, instructionTokens?: Array<{
    type: string;
    text?: string;
}>): import("../../v2/types/index.js").OpenXmlNode[];
//# sourceMappingURL=index-preprocessor.d.ts.map