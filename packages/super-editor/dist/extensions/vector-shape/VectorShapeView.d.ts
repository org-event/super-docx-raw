export class VectorShapeView {
    ...
    createSVGElement(attrs: any): SVGSVGElement;
    /**
     ...
     */
    applyLineEnds(svg: SVGElement, attrs: any): void;
    /**
    ...
    applyGradientToSVG(svg: any, gradientData: any): void;
    applyAlphaToSVG(svg: any, alphaData: any): void;
    createTextElement(textContent: any, textAlign: any, width: any, height: any, options: any): SVGForeignObjectElement;
    buildView(): void;
    update(): boolean;
    #private;
}
//# sourceMappingURL=VectorShapeView.d.ts.map