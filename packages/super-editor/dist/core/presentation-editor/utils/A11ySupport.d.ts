 ...
 * ```
 */
export declare function syncHiddenEditorA11yAttributes(pmDom: unknown, documentMode: 'editing' | 'viewing' | 'suggesting'): void;
/**
 ...
 * ```
 */
export declare function scheduleA11ySelectionAnnouncement(deps: {
 ...
 * ```
 */
export declare function computeA11ySelectionAnnouncement(editorState: EditorState): {
    from: number;
    to: number;
    message: string;
    key: string;
} | null;
//# sourceMappingURL=A11ySupport.d.ts.map