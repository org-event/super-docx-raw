 ...
 */
export declare function inchesToPx(value: unknown): number | undefined;
/**
 ...
 */
export declare function parseColumns(raw: unknown): ColumnLayout | undefined;
//# sourceMappingURL=LayoutOptionParsing.d.ts.map