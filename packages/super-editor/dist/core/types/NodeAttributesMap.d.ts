...
export type NodeName = {
    [K in keyof NodeAttributesMap]: K;
}[keyof NodeAttributesMap];
/**
 ...
 * ```
 */
export declare function isNodeType<N extends NodeName>(node: {
    type: {
        name: string;
    };
    attrs: unknown;
}, name: N): node is TypedNode<N>;
/**
 ...
 * ```
 */
export declare function assertNodeType<N extends NodeName>(node: {
    type: {
        name: string;
    };
    attrs: unknown;
}, name: N): asserts node is TypedNode<N>;
//# sourceMappingURL=NodeAttributesMap.d.ts.map