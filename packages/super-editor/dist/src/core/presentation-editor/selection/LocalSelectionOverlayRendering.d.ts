 ...
 */
export declare function renderSelectionRects({ localSelectionLayer, rects, pageHeight, pageGap, convertPageLocalToOverlayCoords, }: RenderSelectionRectsDeps): void;
/**
 ...
 */
export declare function renderCaretOverlay({ localSelectionLayer, caretLayout, convertPageLocalToOverlayCoords, }: RenderCaretOverlayDeps): void;
export {};
//# sourceMappingURL=LocalSelectionOverlayRendering.d.ts.map