 ...
 */
export declare class EpochPositionMapper {
    #private;
    /**
     ...
     */
    mapPosFromLayoutToCurrent(pos: number, fromEpoch: Epoch, assoc?: number): number | null;
    /**
     ...
     */
    mapPosFromLayoutToCurrentDetailed(pos: number, fromEpoch: Epoch, assoc?: number): MapPosResult;
}
//# sourceMappingURL=EpochPositionMapper.d.ts.map