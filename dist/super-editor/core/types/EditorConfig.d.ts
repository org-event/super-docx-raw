...
import type { FontsResolvedPayload, Comment, CommentsPayload, CommentLocationsPayload, ListDefinitionsPayload } from './EditorEvents.js';
 ...
 */
export type EditorExtension = Extension<Record<string, unknown>, Record<string, unknown>> | EditorNode<Record<string, unknown>, Record<string, unknown>> | EditorMark<Record<string, unknown>, Record<string, unknown>>;
/**
