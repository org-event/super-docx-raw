...
function formatHeadingAsSetext(node, state) {
  ...
  index.visit(node, function(node2) {
  ...
  return Boolean(
    (!node.depth || node.depth < 3) && index.toString(node) && (state.options.setext || literalWithBreak)
  );
}
...
exports.encodeCharacterReference = encodeCharacterReference;
exports.formatCodeAsIndented = formatCodeAsIndented;
exports.formatHeadingAsSetext = formatHeadingAsSetext;
...
exports.patternInScope = patternInScope;
